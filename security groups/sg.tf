...
resource "aws_vpc_security_group_ingress_rule" "http" {security_group_id = aws_security_group.web_sg.id
description = "HTTP"
from_port = 80
to_port = 80
ip_protocol = "tcp"
...
resource "aws_vpc_security_group_ingress_rule" "ssh" {security_group_id = aws_security_group.web_sg.id
description = "ssh"
from_port = 22
to_port = 22
ip_protocol = "tcp"
...
descriptoon = "Allow all outbound"
ip_protocol = "-1"
cidr_ipv4 = "0.0.0.0/0"
tags = {
